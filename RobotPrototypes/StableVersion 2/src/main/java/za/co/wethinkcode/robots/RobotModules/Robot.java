...
public class Robot 
{
    ...
    /** Maximum shots for this robot type */
    private final int MAX_SHOTS_CAPACITY;
    ...
    /** Maximum durability for this robot */
    private final int MAX_DURABILITY;
    
    /** Current number of shots the robot can fire */
    ...
    public Robot(String buildArg, int rateArg, int durabilityArg, int maxShotsArg) 
    {
        ...
        this.MAX_DURABILITY = durabilityArg;
        this.maxShots = maxShotsArg;
        this.MAX_SHOTS_CAPACITY = maxShotsArg;
     ...
     * Costs 20 fuel units to perform.
     */
    public void repair() 
    {
        if (fuelAmount >= 20) 
    ...
    /**
     * Reloads the robot's ammunition to maximum capacity
     */
    public void reload() 
    {
        maxShots = MAX_SHOTS_CAPACITY;
        logger.info(name + " reloaded to " + maxShots + " shots");
    }
    
    /**
     * Takes damage and reduces durability
     * 
    ...
    public void takeDamage(int damage) 
    {
        ...
        logger.info(name + " took " + damage + " damage. Durability: " + durability);
    }
    
    /**
     * Checks if robot is alive (durability > 0)
     */
