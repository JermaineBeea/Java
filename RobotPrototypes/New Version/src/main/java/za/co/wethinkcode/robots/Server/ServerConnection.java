...
public class ServerConnection 
{
    ...
    private void connectClients() throws Exception
    {
        ...
        while (serverSocket.isBound() && !serverSocket.isClosed())
        {
            ...
            ServerSideHandshake handShake = new ServerSideHandshake(clientSocket);
            System.out.println();
            logger.info("Validation Test: Send and receive decrypted code from client...");
            handShake.performHandshake();
            System.out.println();
            logger.info("Validation Test: Handshake received!\nCreating thread for client.");
